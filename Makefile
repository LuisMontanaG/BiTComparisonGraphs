run_app:
	...
	wget -r http://127.0.0.1:8050/_dash-component-suites/dash/dcc/async-checklist.js
	wget -r http://127.0.0.1:8050/_dash-component-suites/dash/dcc/async-input.js
